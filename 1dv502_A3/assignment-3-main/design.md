...
Below is the updated class diagram reflecting the AIPlayer changes.

![Updated Class Diagram](img/class_diagram.png)  # Change filename if needed

## Updated Class Diagram
Below is the updated class diagram reflecting the AIPlayer changes.

![Updated Class Diagram](img/class_diagram.png)  

## Updated Object Diagram
Below is the updated object diagram showing the game structure.

![Updated Object Diagram](img/object_diagram.png)  

## Updated Sequence Diagram
Below is the updated sequence diagram showing the game flow.

![Updated Sequence Diagram](img/sequence_diagram.png)
